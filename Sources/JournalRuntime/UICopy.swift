public enum UICopy {
    ...
    public static let JOURNAL_CHILD_CONTAINMENT_UNRESOLVED = "journal stopped because its child processes could not be safely cleaned up; quit and reopen solstone before starting again"
