...
internal enum InstallerKnownValues {
    internal static let eventTypes: [String] = [
        "setup.started",
        "setup.completed",
        "step.started",
        "step.completed",
    ...
    internal static let errorCodes: [String] = [
        "doctor_failed",
    ...
    internal static let stepNames: [String] = [
        "doctor",
        "journal",
        "install_models",
        "skills",
    ...
    internal static let skippedReasons: [String] = [
        "--skip-models",
        "--skip-skills",
        "--skip-service",
        "packaged_install",
    ...
    internal static let statusTranslation: [String: String] = [
        "ok": "ok",
        "warn": "warning",
        "fail": "failed",
        "skip": "skipped"
