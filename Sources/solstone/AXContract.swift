...
enum AXContract {
    ...
    static let staticIDs: [String] = [
        ...
        AXID.Settings.Permissions.screenRecordingRestartPending,
        ...
        AXID.Settings.Help.diagnosticsConnectedThroughRow,
    ...
    static var states: [String: StateBinding] {
        [
            ...
            AXID.Settings.Permissions.screenRecordingRestartPending: .freeform,
