...
enum AXContract {
    ...
    static var states: [String: StateBinding] {
        [
            ...
            AXID.Updates.statusState: .enum("UpdateStatus"),
            AXID.Updates.checkState: .freeform,
            AXID.Updates.downloadState: .freeform,
            AXID.Updates.retryState: .freeform,
            AXID.Updates.checkAgainState: .freeform,
            AXID.Updates.downloadProgress: .numeric,
            AXID.Updates.extractProgress: .numeric,
            AXID.Updates.deferredInstallState: .freeform,
            AXID.Updates.frequencyState: .enum("FrequencyOption"),
            // updates.debug.state is a DEBUG picker control, not a product state-value companion.
            AXID.Updates.debugStatePicker: .freeform,
