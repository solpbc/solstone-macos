...
enum AXContract {
    ...
    static let staticIDs: [String] = [
        ...
        AXID.Menubar.startButton,
        AXID.Menubar.stopButton,
        ...
        AXID.Settings.Permissions.start,
        AXID.Settings.Permissions.stop,
        AXID.Settings.Permissions.sourceStatus,
        AXID.Settings.Permissions.screenCaptureEnabled,
        AXID.Settings.Permissions.microphoneCaptureEnabled,
        ...
        AXID.Settings.Permissions.screenRecordingResetHint,
        ...
        AXID.Settings.Service.journalOpen,
        ...
        AXID.Settings.Status.lastDeliveryState,
        AXID.Settings.Status.lastDeliveryTimestamp,
        ...
        AXID.Settings.Help.diagnosticsPreview,
        AXID.Settings.Help.diagnosticsCopy,
        AXID.Settings.Help.diagnosticsCopyResultState,
        AXID.Settings.Help.diagnosticsAppVersionRow,
        AXID.Settings.Help.diagnosticsScreenRecordingRow,
        AXID.Settings.Help.diagnosticsScreenRecordingState,
        AXID.Settings.Help.diagnosticsMicrophoneRow,
        AXID.Settings.Help.diagnosticsMicrophoneState,
        AXID.Settings.Help.diagnosticsCaptureRow,
        AXID.Settings.Help.diagnosticsCaptureState,
        AXID.Settings.Help.diagnosticsLastDeliveryRow,
        AXID.Settings.Help.diagnosticsLastDeliveryState,
        AXID.Settings.Help.diagnosticsLastDeliveryTimestamp,
        AXID.Settings.Help.diagnosticsLastJournalConnectionRow,
        AXID.Settings.Help.diagnosticsLastJournalConnectionState,
    ...
    static var vocabularies: [String: [String]] {
        [
            ...
            "LastJournalDeliveryAXState": LastJournalDeliveryAXState.allCases.map(\.axToken),
    ...
    static var states: [String: StateBinding] {
        [
            ...
            AXID.Settings.Status.lastDeliveryState: .enum("LastJournalDeliveryAXState"),
            AXID.Settings.Status.lastDeliveryTimestamp: .numeric,
            AXID.Settings.Status.lastErrorState: .freeform,
            AXID.Settings.Help.diagnosticsCopyResultState: .enum("DiagnosticCopyAXState"),
            AXID.Settings.Help.diagnosticsScreenRecordingState: .enum("AXPermissionState"),
            AXID.Settings.Help.diagnosticsMicrophoneState: .enum("AXPermissionState"),
            AXID.Settings.Help.diagnosticsCaptureState: .enum("DiagnosticCaptureAXState"),
            AXID.Settings.Help.diagnosticsLastDeliveryState: .enum("LastJournalDeliveryAXState"),
