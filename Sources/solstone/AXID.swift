...
enum AXID {
    ...
    enum Settings {
        ...
        enum Service {
            ...
            static let journalOpen = "settings.service.journal.open"
        ...
        enum Status {
            ...
            static let setupVerdictState = "settings.status.setup.verdict.state"
            static let setupSolAppState = "settings.status.setup.solApp.state"
            static let setupSolAppAction = "settings.status.setup.solApp.action"
            static let setupJournalAppState = "settings.status.setup.journalApp.state"
            ...
            static let setupMicrophoneAction = "settings.status.setup.microphone.action"
            ...
            static let lastDeliveryState = "settings.status.upload.lastDelivery.state"
            static let lastDeliveryTimestamp = "settings.status.upload.lastDelivery.timestamp.state"
        ...
        enum Help {
            ...
            static let diagnosticsPreview = "settings.help.diagnostics.preview"
            static let diagnosticsCopy = "settings.help.diagnostics.copy"
            static let diagnosticsCopyResultState = "settings.help.diagnostics.copyResult.state"
            static let diagnosticsAppVersionRow = "settings.help.diagnostics.appVersion.row"
            static let diagnosticsScreenRecordingRow = "settings.help.diagnostics.screenRecording.row"
            static let diagnosticsScreenRecordingState = "settings.help.diagnostics.screenRecording.state"
            static let diagnosticsMicrophoneRow = "settings.help.diagnostics.microphone.row"
            static let diagnosticsMicrophoneState = "settings.help.diagnostics.microphone.state"
            static let diagnosticsCaptureRow = "settings.help.diagnostics.screenAndAudio.row"
            static let diagnosticsCaptureState = "settings.help.diagnostics.screenAndAudio.state"
            static let diagnosticsLastDeliveryRow = "settings.help.diagnostics.lastDelivery.row"
            static let diagnosticsLastDeliveryState = "settings.help.diagnostics.lastDelivery.state"
            static let diagnosticsLastDeliveryTimestamp = "settings.help.diagnostics.lastDelivery.timestamp.state"
            static let diagnosticsLastJournalConnectionRow = "settings.help.diagnostics.lastJournalConnection.row"
            static let diagnosticsLastJournalConnectionState = "settings.help.diagnostics.lastJournalConnection.state"
            ...
            static let diagnosticsConnectedThroughRow = "settings.help.diagnostics.connectedThrough.row"
