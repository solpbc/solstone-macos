...
internal enum DiagnosticEvidenceCode: String, Codable, Equatable, Sendable, CaseIterable {
    ...
    case terminationCommittedOrdinaryQuit = "termination.committed.ordinary_quit"
    case terminationCommittedExternalQuit = "termination.committed.external_quit"
    case terminationCommittedSettingsRestart = "termination.committed.settings_restart"
    case terminationCommittedUpdaterInstall = "termination.committed.updater_install"
    case terminationMarkerWriteFailed = "termination.marker_write_failed"
    case terminationSettingsRelaunchSpawnFailed = "termination.settings_relaunch_spawn_failed"
    case terminationUpdaterInstallRecovered = "termination.recovered.updater_install"
