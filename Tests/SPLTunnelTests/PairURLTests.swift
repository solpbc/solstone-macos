...
struct PairURLTests {
    ...
    @Test func wellKnownRelayReferenceVectorParses() throws {
        ...
        #expect(pairURL.sBytes == [0x01, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xCD, 0xEF])
        #expect(pairURL.nonceBytes == [])
    ...
    @Test func customRelayReferenceVectorParses() throws {
        ...
        #expect(pairURL.kind == .relay)
        #expect(pairURL.sBytes == [0x01, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xCD, 0xEF])
        #expect(pairURL.relayOrigin?.absoluteString == "https://staging.link.solstone.app")
    }
    ...
    private static let customRelayBlob = "0R0J6HB7H6NWVVR1VTPVXVYAZTXBW0938NKRKAYDXWGPGX3ME1SKMBSFEDT62SV9DSKJWV39DSNJWWVFDHSQ8VVECMQ62W3G"
