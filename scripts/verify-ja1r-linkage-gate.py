...
SPL_LINK_CHECK_KEYS = (
    ...
    "journal_menu_affordance_enabled",
    "journal_window_present",
    "journal_window_state_companion_unique",
    "journal_window_state_loaded",
    "journal_window_webview_present",
    "journal_window_retry_absent",
    "journal_window_landmarks_present",
    "journal_home_destination_loaded",
    "journal_search_navigation_dispatched",
    "journal_search_destination_loaded",
    "journal_home_navigation_dispatched",
